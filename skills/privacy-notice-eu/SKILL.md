...
license: Apache-2.0
lq_ai:
  title: Pan-EU GDPR Privacy Notice Generator
  version: 1.0.0
  author: Oliver Schmidt-Prietz
  tags: [gdpr, privacy-notice, datenschutzerklaerung, art-13-14, multi-jurisdiction-eu, docx, ai-act-transparency]
  jurisdiction: eu
  trigger_examples:
    - "Draft a GDPR privacy notice for our German e-commerce site."
    - "Create an applicant privacy notice (Bewerber-Datenschutz) for DE + FR."
    - "We need an employee privacy notice — § 26 BDSG, works council, IT monitoring."
    - "Generate a B2C customer privacy notice with cookies and AI disclosure."
  inputs:
    required:
      - "Notice type (Website/App, Applicant, Employee, Business Partner, B2C, or Combined)"
      - "Target jurisdiction(s) and controller identity"
    optional:
      - "Existing template/notice to use as the base"
      - "Data inventory, processors, transfers, cookies, AI processing details"
      - "Language approach for multi-jurisdiction services"
