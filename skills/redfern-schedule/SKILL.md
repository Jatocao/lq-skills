...
description: "Use when preparing, responding to, or ruling on a Redfern Schedule for document production in international arbitration. Builds and maintains the request-to-produce table for the requesting party, the producing party, or the tribunal across rounds. Applies the IBA Rules on the Taking of Evidence (2020) Article 3.3 admissibility checklist and the Article 9.2 grounds for objection, raises a content-based political and institutional sensitivity prompt when a party is a State or state-owned entity, and produces an internal memo flagging the user's own weak requests or objections. Enforces form and the admissibility checklist. It does not decide whether a document is material or whether an objection will succeed."
author: Alexios vdSK
jurisdiction: MULTI
