...
lq_ai:
  ...
  tags: [nis2, cybersecurity, eu-directive-2022-2555, bsig, gap-analysis, critical-infrastructure, incident-reporting, compliance-roadmap]
  jurisdiction: eu
  trigger_examples:
    - "Does NIS2 apply to my company?"
    - "Are we an essential or important entity under NIS2?"
    - "Run a NIS2 Art. 21 gap analysis for a German energy operator and give me a 12-month roadmap."
    - "What are the BSI registration obligations under BSIG-neu?"
    - "We received a NIS2 contractual requirement from a customer — are we actually in scope?"
  inputs:
    required:
      - "Sector(s) and the specific services the organization provides"
      - "Organization size: headcount, annual turnover, balance-sheet total"
    optional:
      - "Member State focus (e.g., Germany / BSIG-neu) or cross-border group structure"
      - "Existing ISO 27001 posture or certification"
      - "Current maturity of each Art. 21 risk-management measure (if known)"
