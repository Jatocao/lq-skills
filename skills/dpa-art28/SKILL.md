...
license: Apache-2.0
lq_ai:
  title: DPA Art. 28 GDPR — Review, Drafting & Redlining
  version: 1.0.0
  author: Oliver Schmidt-Prietz
  tags: [gdpr, dpa, art-28, art-26, data-processing-agreement, joint-controller, contract-review, redline, bilingual-de-en]
  jurisdiction: eu
  trigger_examples:
    - "Review this DPA for Art. 28(3) compliance — should we sign?"
    - "Draft a processor agreement (AVV) for a German SaaS vendor."
    - "Redline this counterparty DPA from the controller's side."
    - "Are these parties joint controllers or controller-processor?"
    - "Prepare a Joint Controller Arrangement under Art. 26."
  inputs:
    required:
      - "The DPA / AVV text (for review or redline), or the processing scenario (for drafting)"
      - "Roles: who is controller, who is processor (or whether joint controllers)"
    optional:
      - "Perspective: controller-favorable / processor-favorable / balanced"
      - "Language: DE / EN / bilingual"
      - "Tier: Commercial / Strict (2021/915 unmodified) / Hybrid"
      - "International-transfer scope, sub-processor model, special-category data"
